<template >
  <v-row justify="center" class="crear">
  <v-container >
    ...
    <v-row>
      <v-col cols="12">
        ...
        <p>Los medios audiovisuales son reconocidos como aquellos medios de comunicación social que se relacionan estrechamente con la imagen, fotografía, video y audio.</p>
      </v-col>
    </v-row>
